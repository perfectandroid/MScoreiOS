...
class ksebConfirmationAlertViewController: UIViewController {
    
    @IBOutlet weak var fromAccL: UILabel!
    @IBOutlet weak var fromAccBranchL: UILabel!
    @IBOutlet weak var conNameL: UILabel!
    @IBOutlet weak var conMobL: UILabel!
    @IBOutlet weak var condetailsL: UILabel!
    ...
    override func viewDidLoad() {
        ...
        conNameL.text           = conNameLtxt
        conMobL.text            = conMobLtxt
        condetailsL.text        = conDetailLtxt
